        ...
        try:
            ...
            for i, ip_info in enumerate(target_ips):
                ...
                speed_result = {
                    ...
                    'test_type': test_type,
                    'port': self.current_port  # 修改：保存测速使用的端口
                }
...
class CloudflareScanUI(QWidget):
    ...
    def init_ui(self):
        ...
        title.setFont(FONT_TITLE)  # FONT_TITLE 已经设置为加粗
            ...
            with open(file_name, 'w', newline='', encoding='utf-8-sig') as csvfile:
                ...
                for i, result in enumerate(self.speed_results, 1):
                    writer.writerow({
                        ...
                        '端口': result.get('port', 443),  # 修改：包含端口信息
